...
namespace Sakanatcom.Areas.Admin.Controllers
{
    ...
    public class ContactController : Controller
    {
        ...
        public IActionResult Message(HomeViewModel data)
        {
            if (!ModelState.IsValid)
            {
                ViewBag.Message = "Failed to send your message";
                return RedirectToAction("Index", "Contact", new { Message = ViewBag.Message });
            }

            ViewBag.Message = "Your Message Is Sent Successfully";
